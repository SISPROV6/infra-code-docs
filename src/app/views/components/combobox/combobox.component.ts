...
export class ComboboxComponent implements OnInit, OnDestroy {
  ...
  public codeSnippets: string[] = [
    ...
    `<form [formGroup]="formCombobox1">\n  <div class="row">\n      <div class="col-6">\n        <lib-combobox labelText="Pessoa" [list]="pessoasList" controlName="CRPPESSOAID" [control]="formCombobox1.controls['CRPPESSOAID']" />\n      </div>\n  </div>\n</form>`,
