...
export class ComponentsComponent {
  ...
  public components: { nome: string, rota: string, descricao: string, implementacao: 0 | 1 | 2 }[] = [
    ...
    { nome: "Máscaras", rota: "mascaras", descricao: "Máscaras para inputs/texto puro", implementacao: 2 },
    { nome: "Modais", rota: "modais", descricao: "Padrões para exibição de modais nas telas", implementacao: 2 },
